...
const Searchbar = ({placeholder}:{placeholder?:string}) => {
    ...
    const handelSelect = (ranges: RangeKeyDict) => {
...
return (
    ...
    {input && <div className="flex flex-col col-span-3 absolute top-[100%] left-[50%] translate-x-[-50%]">
        ...
        <div className="flex items-center p-5 bg-white">
            ...
            >Cancel</button>
            <Link
                href={`/search?location=${input}&startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}&numberOfGuests=${numberOfGuests}`}
                onClick={() => setInput("")}
